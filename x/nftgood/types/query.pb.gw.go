...
var (
	pattern_Query_Poll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"manolaz", "nftgood", "poll", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PollAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"manolaz", "nftgood", "poll"}, "", runtime.AssumeColonVerbOpt(true)))
)
